...
public interface Errors extends org.ros.internal.message.Message {
  ...
  boolean getJointP2pInsufficientTorqueForPlanning();
  void setJointP2pInsufficientTorqueForPlanning(boolean value);
  boolean getTauJRangeViolation();
  void setTauJRangeViolation(boolean value);
  boolean getInstabilityDetected();
  void setInstabilityDetected(boolean value);
}
